...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Streamies: 1 minute
        ...
        strObfuscationPoolDummyAddress = "SWSbBnzmNkjDVaYHX7vkL1MqD96pRYWtZo";
...
public:
    CTestNetParams()
    {
        ...
        nDefaultPort = 22129;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Streamies: 1 day
        nTargetSpacing = 1 * 60;  // Streamies: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Streamies: 1 day
        nTargetSpacing = 1 * 60;        // Streamies: 1 minutes
