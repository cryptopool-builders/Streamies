...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Streamies Core streamies-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  streamies-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded streamies transaction") + "\n" +
                               "  streamies-tx [options] -create [commands]   " + _("Create hex-encoded streamies transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded streamies transaction
