...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Streamies features */
        {"streamies", "listmasternodes", &listmasternodes, true, true, false},
        {"streamies", "getmasternodecount", &getmasternodecount, true, true, false},
        {"streamies", "masternodeconnect", &masternodeconnect, true, true, false},
        {"streamies", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"streamies", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"streamies", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"streamies", "masternodecurrent", &masternodecurrent, true, true, false},
        {"streamies", "masternodedebug", &masternodedebug, true, true, false},
        {"streamies", "startmasternode", &startmasternode, true, true, false},
        {"streamies", "createmasternodekey", &createmasternodekey, true, true, false},
        {"streamies", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"streamies", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"streamies", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"streamies", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"streamies", "getmasternodescores", &getmasternodescores, true, true, false},
        {"streamies", "preparebudget", &preparebudget, true, true, false},
        {"streamies", "submitbudget", &submitbudget, true, true, false},
        {"streamies", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"streamies", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"streamies", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"streamies", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"streamies", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"streamies", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"streamies", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"streamies", "checkbudgets", &checkbudgets, true, true, false},
        {"streamies", "mnsync", &mnsync, true, true, false},
        {"streamies", "spork", &spork, true, true, false},
        {"streamies", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> streamies-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:55297/\n";
}
