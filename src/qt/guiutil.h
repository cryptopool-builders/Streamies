...
/** Utility functions used by the Streamies Qt UI.
 */
namespace GUIUtil
{
...
// Render Streamies addresses in monospace font
...
// Parse "streamies:" URI into recipient object, return true on successful parsing
