...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Streamies Core"),
     ...
     * override -datadir in the streamies.conf file in the default data directory
     * (to be consistent with streamiesd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
