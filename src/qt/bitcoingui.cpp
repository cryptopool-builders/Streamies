                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Streamies Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Streamies address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and streamies: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Streamies Core"), this);
    aboutAction->setStatusTip(tr("Show information about Streamies Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Streamies"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Streamies addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Streamies addresses"));
    ...
    openAction->setStatusTip(tr("Open a Streamies: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Streamies Core help message to get a list with possible Streamies command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Streamies Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Streamies network", "", count));
}
...
{
    QString strTitle = tr("Streamies Core"); // default title
