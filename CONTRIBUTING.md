Contributing to Streamies Core
============================

The Streamies Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Streamies Core project, and is not to be
confused with overall Streamies Network Protocol consensus changes.

Whether a pull request is merged into Streamies Core rests with the project merge
...
Patches that change Streamies consensus rules are considerably more involved than
...
Where a patch set proposes to change the Streamies consensus, it must have been
...
The project leader is the release manager for each Streamies Core release.
