...
*Setup instructions for a gitian build of STRMS using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the STRMS
...
- [Building STRMS](#building-streamies)
...
To build STRMS (for Linux, OSX and Windows) just follow the steps under 'perform
