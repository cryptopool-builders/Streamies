Streamies Core version 2.2.1 is now available from:
...
Streamies Core is extensively tested on multiple operating systems using
...
Streamies Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Streamies was forked from.
