...
In order to support loading of multiple wallets in streamies-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is streamies.cpp.
...
Changes to streamies.cpp
----------------------
streamies.cpp is the entry point into streamies-qt, and as such, will require some minor modifications to provide hooks for
